...
export default function SignIn({providers} : Props ) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '90vh'}}>
      ...
      <div style={{height: '12rem', width: '30rem', display: 'grid', alignItems: 'center', justifyContent: 'center',}}>
        ...
        <div key={provider.name} style={{margin: 'auto'}}>
          <button style={{ padding: 5, width: 180, display: 'flex', alignItems: 'center', gap: 5, fontWeight: 500, justifyContent: 'center'  }} onClick={() => signIn(provider.id, {
              callbackUrl: '/',
            })}>
          <FcGoogle fontSize={24} className="mr-2" />
